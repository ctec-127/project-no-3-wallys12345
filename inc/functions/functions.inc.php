...
//the function below displays each field name and information for every record queried in the database
//which it does row by row
function display_record_table($result){
    echo '<div class="table-responsive">';
    echo "<table class=\"table table-striped table-hover table-sm mt-4\">";
    echo '<thead class="thead-dark"><tr><th>Actions</th><th><a href="?sortby=student_id">Student ID</a></th>
          <th><a href="?sortby=first_name">First Name</a></th><th><a href="?sortby=last_name">Last Name</a></th>
          <th><a href="?sortby=email">Email</a></th>
          <th><a href="?sortby=phone">Phone</a></th><th><a href="?sortby=degree_program">Degree Program</a></th>
          <th><a href="?sortby=gpa">Gpa</a></th><th><a href="?sortby=financial_aid">Financial Aid</a></th></tr></thead>';
...
//function diplays the collected errors in the error bucket
